...
export var Student = React.createClass({
  render: function() {
    var {childName, key} = this.props.student;
  ...
  return (
      <Row key= {key} style={{padding: '8px 10px', borderBottom: '1px solid #cccccc', display: 'flex', alignItems: 'center'}}>
        <Col xs={9} md={9} style={{fontSize: '14px'}}>
          <div>
                <input type="checkbox" name="attendSwitch" style={{marginRight: '5px'}} readOnly/><Glyphicon glyph="user" /> {truncatedName}
          </div>
