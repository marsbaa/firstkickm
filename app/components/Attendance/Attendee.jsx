...
class Attendee extends React.Component {
  render() {
    var { dispatch, date, type, calendars, selection, centreName } = this.props;
    var {
      childName,
      key,
      attendance,
    ...
    if (type !== 'makeup') {
      ...
      termId = getTermByDate(calendars[calendarKey], date);
      paid = paidDate(payments, date, termId, moment(date).year());
    }
    ...
    return (
      ...
      >
        ...
        <Col
          xs={6}
          md={6}
          style={{ fontSize: '14px', color: type=== 'makeup' ? 'blue' : paid ? '#656565' : 'red' }}
        >
